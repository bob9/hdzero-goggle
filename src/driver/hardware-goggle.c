...
void Display_720P60_50_t(int mode, uint8_t is_43) // fps: 0=50, 1=60
{
    ...
    if (mode == VR_540P60) {
        ...
        screen.mfpga.set720p60(mode, is_43);
    }
    screen.vtmg(1);
...
void AV_Mode_Switch_fpga(int is_pal) {
    ...
    // BoxPro restores pclk after the dispw VDPO re-time. Test that without
    // also reapplying G1's vclk phase, which G2/BoxPro do not do here.
